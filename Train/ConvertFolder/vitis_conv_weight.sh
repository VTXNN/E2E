...
sed -i '/config_array_partition maximum_size="4096"/d' Quantised_model_prune_iteration_9_hls_weight_vitis/myproject_prj/solution1/solution1.aps
sed -i '/config_compile name_max_length="80"/d' Quantised_model_prune_iteration_9_hls_weight_vitis/myproject_prj/solution1/solution1.aps

cp build_vitis_prj.tcl Quantised_model_prune_iteration_9_hls_weight_vitis
