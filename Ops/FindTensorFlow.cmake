...
execute_process(
	COMMAND ${PYTHON_EXECUTABLE} -c "import tensorflow as tf; print('tf_version',tf.__version__)"
...
execute_process(
	COMMAND ${PYTHON_EXECUTABLE} -c "import tensorflow as tf; print('tf_includepath',tf.sysconfig.get_include())"
